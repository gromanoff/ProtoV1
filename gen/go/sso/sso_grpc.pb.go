...
type AuthClient interface {
	Register(ctx context.Context, in *RegistrRequest, opts ...grpc.CallOption) (*RegisterResponse, error)
...
func (c *authClient) Register(ctx context.Context, in *RegistrRequest, opts ...grpc.CallOption) (*RegisterResponse, error) {
...
type AuthServer interface {
	Register(context.Context, *RegistrRequest) (*RegisterResponse, error)
...
func (UnimplementedAuthServer) Register(context.Context, *RegistrRequest) (*RegisterResponse, error) {
